...
class ViewController: UIViewController {
    ...
    func showResult() {
        let ac = UIAlertController(title: "Well done!", message: "Questions asked: \(maxQuestion)\nFinal score \(score)", preferredStyle: .alert)
    ...
    @IBAction func UIButtonTapped(_ sender: UIButton) {
        ...
        //update title before presenting the alert to have a matching score in the title bar
